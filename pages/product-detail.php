...
=======
            <div class="product-card product-clickable" onclick="window.location.href='product-detail.php?id=<?php echo $related['id']; ?>'">
>>>>>>> 3be3e54cf790d1b58872b3ae93f5796e18941695
...
=======
                    <p class="price"><?php echo number_format($related['price'], 0, ',', '.'); ?> VND</p>
                    <button class="btn-primary" onclick="event.stopPropagation(); window.location.href='product-detail.php?id=<?php echo $related['id']; ?>'">View Details</button>
>>>>>>> 3be3e54cf790d1b58872b3ae93f5796e18941695
                </div>
            </div>
            <?php endforeach; ?>
