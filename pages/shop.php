                                    ...
                                    <div class="card-content">
                                        ...
                                        <?php if (($p['discount'] ?? 0) > 0): ?>
                                            <p class="price">
                                                ...
                                                <span style="color: #e60023; font-weight: bold;"><?php echo number_format($p['price'] * (1 - $p['discount']/100), 0, ',', '.'); ?>₫</span>
                                            </p>
                                        <?php else: ?>
                        ...
                        <div class="item-card" onclick="window.location.href='product-detail.php?id=<?php echo $p['id']; ?>'">
                            ...
                            <?php if (($p['discount'] ?? 0) > 0): ?>
                                <p class="product-price">
                                    ...
                                    <span style="color: #e63946; font-weight: bold;"><?php echo number_format($p['price'] * (1 - $p['discount']/100), 0, ',', '.'); ?>₫</span>
                                </p>
                            <?php else: ?>
